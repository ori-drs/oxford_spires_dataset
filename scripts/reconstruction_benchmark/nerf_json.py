...
def split_json(json_file, start_time, end_time, new_name):
    ...
    pose_ply_file = Path(json_file).parent / f"{new_name}.ply"
...
split_json(json_file, start_time, end_time, train_name)
split_json(json_file, start_time, end_time, eval_name)


image_dir = dataset_folder / "images"
json_train_file = colmap_folder / (train_name + ".json")
json_eval_file = colmap_folder / (eval_name + "json")
new_image_dir = Path(image_dir).parent / "images_train_eval"
